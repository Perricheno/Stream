...
/** Tapping opens ParticipantsModal — the full list, with host-only remove and an invite shortcut. */
export function ParticipantsBar({ participants, onOpen }: ParticipantsBarProps) {
